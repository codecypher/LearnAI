...
NOTE: These coefficients must be estimated on the training dataset only.
...
NOTE: The order that the transform operations are applied is important.

We can see how the transforms may interact.
...
[5 Ways to Use Cross-Validation to Improve Time Series Models](https://machinelearningmastery.com/5-ways-to-use-cross-validation-to-improve-time-series-models/)
