...
Here is a checklist that can help with Machine Learning projects [1]:

## Steps to Solving Machine Learning Project
...
2. Write monitoring code to check your system’s live performance at regular intervals and trigger alerts when it drops.
   ...
   - Monitor input quality (such as a malfunctioning sensor sending random values, or another team’s output becoming stale) which is important for online learning systems.

3. Retrain models on a regular basis on fresh data (automate as much as possible).

## References

[1[: A. Geron, _Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow_, 2nd ed., Oreilly Media, 2019.
