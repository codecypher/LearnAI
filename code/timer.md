...
Here we disucss how to measure the execution time of Python code [1], [2].

## Simple Timer Decorator

Here is a simple decorator that we can easily apply to real-world problems for debugging code [1].

```py
    def timer(func):
      """
      Display the time it took for the function to run.
      """
      @wraps(func)
...
We can use Python decorators to easily log the execution time of any Python function [3].
...
Here is some sample code using the decorator.
...
Here we discuss how to measure the execution time of your code in Python the right way [2].
...
[3]: [Logging Method Execution Time in Python](https://medium.com/geekculture/logging-method-execution-time-in-python-145469c92653)
